<x-guest-layout>
    ...
    @php
        if(isset($_GET['d']) && $_GET['d'] != ''){
            session()->put('redirectURL', $_GET['d']);
        }
    @endphp

    <section class="pageBreadcumb--style1 position-relative"
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4 align-middle ">
                <a href="{{ route('auth.google') }}">
                    <img src="{{ URL::to('website/image/google/btn_google_signin_dark_normal_web.png') }}"
